    ...
    public static class HelpPageConfig
    {
        ...
        public static void Register(HttpConfiguration config)
        {
            ...
            { 
                ...
                {typeof(Event), "{\"eventId\":2,\"groupId\":0,\"schoolUserId\":37,\"name\":\"Junta bimestral\",\"date\":\"2015-06-06T05:00:00\",\"creationDate\":\"2015-05-27T15:12:48\",\"description\":\"Junta de revisión de calificaciones bimestral, también hablaremos sobre el festival de día de las madres y el convivio por el día del niño\",\"links\":[{\"rel\":\"self\",\"href\":\"http://api.edutor-tt.com/events/2\",\"method\":\"GET\"},{\"rel\":\"attendees\",\"href\":\"http://api.edutor-tt.com/events/2/attendees\",\"method\":\"GET\"},{\"rel\":\"schooluser\",\"href\":\"http://api.edutor-tt.com/schoolusers/37\",\"method\":\"GET\"}]}"},
                ...
                {typeof(PagedDataResponse<Conversation>), "{\"pageCount\":1,\"pageNumber\":1,\"pageSize\":20,\"items\":[{\"conversationId\":1,\"senderId\":2,\"senderName\":\"Cairo Chaney\",\"recipientId\":62,\"recipientName\":\"Cassidy O. Gutierrez\",\"lastMessages\":null,\"links\":[{\"rel\":\"self\",\"href\":\"http://api.edutor-tt.com/conversations/1\",\"method\":\"GET\"},{\"rel\":\"messages\",\"href\":\"http://api.edutor-tt.com/conversations/1/messages\",\"method\":\"GET\"}]},{\"conversationId\":2,\"senderId\":2,\"senderName\":\"Cairo Chaney\",\"recipientId\":49,\"recipientName\":\"Elizabeth Alvarado\",\"lastMessages\":null,\"links\":[{\"rel\":\"self\",\"href\":\"http://api.edutor-tt.com/conversations/2\",\"method\":\"GET\"},{\"rel\":\"messages\",\"href\":\"http://api.edutor-tt.com/conversations/2/messages\",\"method\":\"GET\"}]}],\"links\":[{\"rel\":\"currentPage\",\"href\":\"http://api.edutor-tt.com/tutors/2/conversations?pageNumber=1&pageSize=20\",\"method\":\"GET\"}]}"},
